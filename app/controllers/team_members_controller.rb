class TeamMembersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @team_member.save
        format.html { redirect_to @team, notice: 'Team member was successfully created.' }
        format.json { render :show, status: :created, location: @team_member }
      else
        format.html { redirect_to @team, notice: 'Team member was not successfully created.' }
  ...
  private
    ...
    def team_member_params
      params.require(:team_member).permit(:user_id).merge(team_id: @team.id)
    end
end
